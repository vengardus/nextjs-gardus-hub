          ...
          <Pie data={data} dataKey={valueKey as string}>
            <LabelList
              ...
              formatter={(label: React.ReactNode) => {
                // Convertimos label a string y lo forzamos a key de config
                const key = String(label) as keyof typeof config;
                // Devolvemos el label personalizado o, en su defecto, el original
